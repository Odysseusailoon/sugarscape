...
- **Metabolism is Destiny**: The surviving population has an average metabolism of **1.85** (Initial exp: 2.5). Lower metabolism agents have a massive survival advantage.
- **Vision Matters Less**: The average vision is **3.78**. While helpful, it is secondary to metabolic efficiency.

### B. Wealth Inequality
- **Gini Coefficient**: **0.42** (High inequality).
- **The 10% Rule**: The top 10% of agents hold **29.2%** of the total wealth.
