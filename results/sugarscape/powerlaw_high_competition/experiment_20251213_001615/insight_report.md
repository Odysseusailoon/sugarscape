...
- **Metabolism is Destiny**: The surviving population has an average metabolism of **1.94** (Initial exp: 2.5). Lower metabolism agents have a massive survival advantage.
- **Vision Matters Less**: The average vision is **3.76**. While helpful, it is secondary to metabolic efficiency.

### B. Wealth Inequality
- **Gini Coefficient**: **0.48** (High inequality).
- **The 10% Rule**: The top 10% of agents hold **30.3%** of the total wealth.
