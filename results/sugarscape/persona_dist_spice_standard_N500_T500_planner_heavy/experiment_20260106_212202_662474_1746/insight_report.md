...
- **Metabolism is Destiny**: The surviving population has an average metabolism of **1.89** (Initial exp: 2.5). Lower metabolism agents have a massive survival advantage.
- **Vision Matters Less**: The average vision is **3.69**. While helpful, it is secondary to metabolic efficiency.

### B. Wealth Inequality
- **Gini Coefficient**: **0.44** (High inequality).
- **The 10% Rule**: The top 10% of agents hold **30.2%** of the total wealth.
